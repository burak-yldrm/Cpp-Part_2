...
void	PmergeMe::sortList( void )
{
	...
	double durationInMicroseconds = durationInSeconds * 1000000.0;

	std::cout << "\nTime to process a range of " << _vector.size()
	<< " elements with std::list : " << durationInMicroseconds << " us\n";
}
...
void	PmergeMe::sortVector( void )
{
	...
	std::cout << "\nTime to process a range of " << _vector.size()
	<< " elements with std::vector : " << durationInMicroseconds << " us\n";
}
